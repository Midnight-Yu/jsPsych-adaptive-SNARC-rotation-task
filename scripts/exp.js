...
let rotation_value = 4; //旋转试次自适应需要的变量
let standard_rt = 700; //先随便写一个
...
// 注册一个listener，用于测验强制退出
function endExperiment(e) {
    if (e.key === 'Escape') {
        jsPsych.endExperiment('测验已终止');
...
let data_collect = {
    ...
    css_classes: ['non-experiment'],
    html: `
    <p>您的编号：<input type="text" name="participant_index" style="color:black" placeholder="如不知道，请询问测验人员"></p>
...
let instruction = {
    ...
    stimulus: `
    <p>欢迎加入测验！</p>
    <p>本测验分为三个阶段，三个阶段有不同的任务</p>
    <p>每个阶段开始前，都有练习流程帮助你熟悉测验</p>
    <p></p>
    <p>准备好后，按空格键进入测验</p>
    `,
    post_trial_gap: 1000,
...
let instruction_parity_2 = {
    ...
    timeline: [
        {   // 第一页
            ...
            <p>这个部分的规则如下<br><br>
            当你看到单数时，请按下<span style="color:green"> J </span>键<br>
            当你看到双数时，请按下<span style="color:green"> F </span>键</p>

            <p>例如，当你看到 3 时，请按下 J 键<br>
            例如，当你看到 6 时，请按下 F 键</p>
...
let parity_trials = {
    ...
    timeline: [
        ...
        {  //休息试次
            ...
            timeline: [
                {
                    stimulus: `请休息片刻，稍后测验将继续`,
                    trial_duration: 30000,
                    choices: 'NO_KEYS'
                },
                {
                    stimulus: `休息已终止，按空格可继续测验`,
                    choices: ' '
                },
            ],
    ...
    sample: {
        ...
        fn: function (t) {
            ...
            const original_odd_pool = [...Array(10)].flatMap(() => odd_list);
            const original_even_pool = [...Array(10)].flatMap(() => even_list);
...
jsPsych.run([
    ...
    instruction_parity_2, practice_instruction, parity_training_2, practice_feedback, parity_trials_2, 
